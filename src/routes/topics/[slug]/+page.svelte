            ...
            <section class="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div class="flex flex-wrap gap-6 pt-2">
                    {#each topics as topic}
                        ...
                        >
                            <span class="text-zinc-700 group-hover:text-zinc-400 transition-colors"
                                >↳</span
                            >
                            {topic}
                        </a>
                        ...
                        <li class="group">
                            ...
                            >
                                <div class="flex items-center gap-3 relative">
                                    ...
                                    >
                                        <p
                                            class="text-lg font-medium group-hover:text-primary transition-colors flex items-center gap-2"
                                        >
                                            {post.title}
                                        </p>
