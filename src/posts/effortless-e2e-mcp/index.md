...
<span style="color: #FF5151;">有寫過測試的都知道，我們可能會管理一堆 E2E 測試的文件跟腳本（高機率是分開的）。</span>
...
![case-5](./images/case-5.png)

AI 測試完後，這還不是結束哦！你總是要追蹤吧？

![case-6](./images/case-6.png)
