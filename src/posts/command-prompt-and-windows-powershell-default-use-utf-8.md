...
ogImage: '/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/hero.jpg'
...
![cmd-powershell-1](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-1.jpg)
...
![cmd-powershell-2](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-2.jpg)
...
2. 前往 `HKEY_LOCAL_MACHINE\Software\Microsoft\Command Processor` 該位置
   ![cmd-powershell-3](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-3.jpg)
3. 於第二點提到之位置底下新增**字串值**，**數值名稱**為 **Autorun**，**數值資料**為 **chcp 65001>nul**
   ![cmd-powershell-4](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-4.jpg)

此時再次創建一個新的 Process，預設字碼頁就是 65001 了。

![cmd-powershell-5](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-5.jpg)
...
1. 確認 `[console]::OutputEncoding`、`[console]::InputEncoding`、`$OutputEncoding` 這些變數
   ![cmd-powershell-6](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-6.jpg)
2. 確認 `$PROFILE` 變數
   ![cmd-powershell-7](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-7.jpg)
3. 新增 `Microsoft.PowerShell_profile.ps1` 至第二點提到之位置 `C:\Users\UserName\Documents\WindowsPowerShell` 底下
   ![cmd-powershell-8](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-8.jpg)
4. `Microsoft.PowerShell_profile.ps1` 內容如下：  
   ...
   ![cmd-powershell-10](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-10.jpg)

此時再次創建一個新的 Process，預設字碼頁就是 65001 了。

![cmd-powershell-9](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-9.jpg)
...
![cmd-powershell-11](/assets/posts/command-prompt-and-windows-powershell-default-use-utf-8/cmd-powershell-11.jpg)
