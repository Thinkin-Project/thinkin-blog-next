...
![vs-reauth-1](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-1.jpg)

相信大家看到上圖，應該都不陌生，就是當你安裝完 Visual Studio 後會有的試用期啦···

然後當你選擇**使用產品金鑰解除鎖定**時，就會**寫授權進入註冊表中**，所以**之後你幾乎無法透過已有介面來重新輸入授權**，等到需要轉換授權時，就會很頭痛 😩 ···

![vs-reauth-3](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-3.jpg)
...
1. `Windows` 搜尋 `regedit`
   ![vs-reauth-4](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-4.jpg)
2. 搜尋 `HKEY_CLASSES_ROOT\Licenses\41717607-F34E-432C-A138-A3CFD7E25CDA`
   ![vs-reauth-2](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-2.jpg)
3. 刪除它
   ![vs-reauth-6](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-6.jpg)
4. 打開 `Visual Studio Installer` 找到你的 `Visual Studio 2019` 並**修復（repair）**它
   ![vs-reauth-7](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-7.jpg)
...
![vs-reauth-5](/assets/posts/how-to-remove-visual-studio-2019-license/vs-reauth-5.jpg)
