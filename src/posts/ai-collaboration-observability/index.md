...
兩天後我才意識到：我當初真正需要的，只是找同事聊十分鐘。那個問題的核心根本不是技術選型，而是我還不清楚需求是什麼。AI 非常有效率地幫我在一個錯的方向上走得很遠。

這不是 AI 的問題。這是一種很特定的陷阱：**當你問了一個有格式感的問題，你就會得到一個有格式感的答案**——然後你會誤以為這個交換是有價值的。速度感是真實的。但速度不等於進展。
